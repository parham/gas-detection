...
%% Load the dataset
% Dataset path
% dirPath = '/home-local2/panoo.extra.nobkp/current_dataset/SenseFly/solar_panel_reflection/exp01/sample02';
dirPath = '/home/phm/MEGA/working_datasets/reflection_reduction/exp02_small_sample';
fileExt = '*.tif';
